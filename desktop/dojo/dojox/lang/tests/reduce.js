if(!dojo._hasResource["dojox.lang.tests.reduce"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.lang.tests.reduce"] = true;
