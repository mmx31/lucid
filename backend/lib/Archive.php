...
class File_Archive
{
                  ...
                  $uncompression = 0, $directoryDepth = -1)
    {
        ...
        if ((empty($URL) || is_dir($URL)) && $source === null) {
        	import("lib.Archive.Reader.Directory");
			import("lib.Archive.Reader.ChangeName");

            if ($uncompressionLevel != 0) {
				import("lib.Archive.Reader.Uncompress");
            ...
            if ($directoryDepth >= 0) {
				import("lib.Archive.Reader.Filter");
				import("lib.Archive.Predicate.MaxDepth");
        ...
        //Else, we will have to build a complex reader
            ...
            if ($source === null) {
				...
				import("lib.Archive.Reader.Select");
    ...
    function cache(&$toConvert)
    {
        ...
        import("lib.Archive.Reader.Cache");
    ...
    function &_convertToWriter(&$dest)
    {
        if (is_string($dest)) {
            ...
            import("lib.Archive.Writer.Multi");
...
/*        case 'cab':
    ...
    {
        import("lib.Archive.Reader.Multi");
    ...
    function readConcat(&$toConvert, $filename, $stat=array(), $mime=null)
    {
        ...
        import("lib.Archive.Reader.Concat");
    ...
    function predTrue()
    {
        import("lib.Archive.Predicate.True");
    ...
    function predAnd()
    {
        import("lib.Archive.Predicate.And");
    ...
    function predOr()
    {
        import("lib.Archive.Predicate.Or");
    ...
    {
        import("lib.Archive.Predicate.Not");
    ...
    {
        import("lib.Archive.Predicate.MinSize");
    ...
    {
        import("lib.Archive.Predicate.MinTime");
    ...
    {
        import("lib.Archive.Predicate.Extension");
    ...
    {
        import("lib.Archive.Predicate.MIME");
    ...
    {
        import("lib.Archive.Predicate.Ereg");
    ...
    {
        import("lib.Archive.Predicate.Eregi");
    ...
    {
        import("lib.Archive.Predicate.Custom");
    ...
    {
        import("lib.Archive.Writer.Mail");
    ...
    {
        import("lib.Archive.Writer.Output");
                                 ...
                                 $type = null, $stat = array())
    {
        ...
        if (!PEAR::isError($result)) {
            if ($unique) {
                import("lib.Archive.Writer.UniqueAppender");
        ...
        if (empty($baseDir)) {
            ...
            if (PEAR::isError($result)) {
                import("lib.Archive.Writer.AddBaseName");
    ...
    function removeDuplicatesFromSource(&$toConvert, $URL = null)
    {
        ...
        import("lib.Archive.Predicate.Duplicate");
