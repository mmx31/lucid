...
/*--------------------------------------------------
 ...
 | the BSD License or the GNU GPL, and is free to use and redistribute
 | only if this copyright statement is not removed
 +--------------------------------------------------*/

class Desktop_Archive
{
...
class Desktop_Archive_Tar_File extends Desktop_Archive
{
	function __construct($name)
	{
		$this->archive($name);
...
class Desktop_Archive_Gzip_File extends Desktop_Archive_Tar_File
{
	function __construct($name)
	{
		$this->tar_file($name);
...
class Desktop_Archive_Bzip_File extends Desktop_Archive_Tar_File
{
	function __construct($name)
	{
		$this->tar_file($name);
...
class Desktop_Archive_Zip_File extends Desktop_Archive
{
